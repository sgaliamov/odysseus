...
const _PROVIDERS = [
  ...
  // Azure AI / Azure OpenAI (official Simple Icons Azure mark). Matches the
  // `azure` data-logo key and the resource hosts (*.openai.azure.com,
  // *.services.ai.azure.com). Placed before the OpenAI entry so that
  // *.openai.azure.com hosts — whose hostname contains "openai" — still resolve
  // to the Azure logo in providerLogoFromUrl().
  [/azure/i,
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M5.483 21.3H24L14.025 4.013l-3.038 8.347 5.836 6.938L5.483 21.3zM13.23 2.7L6.105 8.677 0 19.253h5.505z"/></svg>'],
...
const _ENDPOINT_LABELS = [
  ...
  [/(^|\.)(openai\.azure\.com|services\.ai\.azure\.com|cognitiveservices\.azure\.com)$/i, "Azure AI"],
  [/(^|\.)openai\.com$/i, "OpenAI"],
